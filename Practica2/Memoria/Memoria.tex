...
% TODO -- estoy etiquetando con funciones mas complejas pero sigo teniendo el umbral del 10% de error. Comentar que esto sigue estando mal porque la introducción del ruido es ad-hoc. Sería mas interesante comprobar el hecho de introducir inicialmente el ruido
