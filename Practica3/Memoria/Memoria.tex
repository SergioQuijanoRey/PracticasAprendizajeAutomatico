...
Tras esta exploración del problema => No tenemos conocimiento suficiente para proponer una trasnformación de los datos en base al conocimiento del problema o una selección de las características más relevantes del problema. Por ello, usamos técnicas estadísticas para selección de características y la técnica CV para selección de modelos / transformaciones
